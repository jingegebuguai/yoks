...
interface RecoilBenchmarkProps {
  itemCount?: number;
  onComplete?: () => void;
}

const RecoilBenchmark: React.FC<RecoilBenchmarkProps> = ({
  itemCount = 1000,
  onComplete,
}) => {
  ...
  useEffect(() => {
    if (isRunning) {
      ...
      console.log(`Recoil benchmark completed in ${endTime - startTime}ms`);
...
export default RecoilBenchmark;
