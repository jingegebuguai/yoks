...
interface JotaiBenchmarkProps {
  itemCount?: number;
  onComplete?: () => void;
}

const JotaiBenchmark: React.FC<JotaiBenchmarkProps> = ({
  itemCount = 1000,
  onComplete,
}) => {
  ...
  useEffect(() => {
    if (isRunning) {
      ...
      console.log(`Jotai benchmark completed in ${endTime - startTime}ms`);
